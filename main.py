...
features = [
    {
      ...
      "apiPath": "/api/get_outstanding_pmt_data",
      "methods": ["POST"],
...

    {
      ...
      "apiPath": "/api/get_pending_orders_data",
      "methods": ["POST"],
...

    {
      ...
      "apiPath": "/api/get_rawmaterial_data",
      "methods": ["POST"],
      "jsonPath": 'static/dbs/rawmat.json',
      },

    {
      "featureName": "FinishedGoods",
      "servingUrl": "/fingoods",
      "templatePath": "templates/fingoods.html",
      "apiPath": "/api/get_finished_goods_data",
      "methods": ["POST"],
      "jsonPath": 'static/dbs/fingoods.json',
      },
